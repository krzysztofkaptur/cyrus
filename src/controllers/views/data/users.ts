export const users = [
  {
    ...
    title: 'Get all users',
    code: `
      fetch('${process.env.BASE_URL}/api/v1/users')
        .then(res=>res.json())
  ...
  },
  {
    ...
    code: `
      fetch('${process.env.BASE_URL}/api/v1/users/1')
        .then(res=>res.json())
        .then(json=>console.log(json))
    `,
    responseExample: `
  ...
  },
  {
    ...
    title: 'Delete a user',
    code: `
      fetch('${process.env.BASE_URL}/api/v1/users/bd127c0b-19c1-4b38-bf7c-68cf65fb1031', {
        method: "DELETE"
      })
        .then(res=>res.json())
        .then(json=>console.log(json))
  ...
  {
    id: 'get_all_users_limit',
    title: 'Get all users - limit',
    code: `
      fetch('${process.env.BASE_URL}/api/v1/users?limit=3')
        .then(res=>res.json())
        .then(json=>console.log(json))
    `,
    responseExample: `
  ...
  ,
  {
    id: 'get_all_users_order',
    title: 'Get all users - order by name',
    code: `
      fetch('${process.env.BASE_URL}/api/v1/users?order=name')
        .then(res=>res.json())
        .then(json=>console.log(json))
    `,
    responseExample: `
  ...
  {
    id: 'get_all_users_pagination',
    title: 'Get all users - pagination',
    code: `
      fetch('${process.env.BASE_URL}/api/v1/users?per_page=3&page=2')
        .then(res=>res.json())
        .then(json=>console.log(json))
    `,
    responseExample: `
